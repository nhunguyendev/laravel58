          ...
          <div class="widget-content nopadding">
            <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" placeholder="Product name" name="name" required value="{{ $product->name }}"/>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" placeholder="Price" name="price" required value="{{ $product->price }}"/>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" placeholder="Featured" name="featured" required value="{{ $product->featured }}"/>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea id="ckeditor" class="span11" name="description" required >{{ $product->description }}</textarea>
                  <script>                    
